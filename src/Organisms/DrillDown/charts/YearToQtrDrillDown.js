...
class YearToQtrDrillDown extends React.Component {
  constructor(props) {
    super(props);
    ...
    */
    ...
    const config = {
      ...
      series: addDrillDownKeyPropToSeries(
        ...
        ({ companyName, name }) =>
          `${companyName} - ${name} - ${name} - byQuarter`
      )
    };
    ...
    return (
      <div className="no-result-message-drilldown" style={{height: '220px'}}>
          <Header
            header={'No Results'}
...
export default YearToQtrDrillDown;